...
class Data_Logic {
    ...
    static get_foreign = (value_type,foreign_table,foreign_field,parent_field,option) => {
        ...
        let foreigns = option.foreigns ? option.foreigns : [];
        return {value_type:value_type,sort_by:sort_by,foreign_table:foreign_table,foreign_field:foreign_field,parent_field:parent_field,field:field,title:title,page_current:page_current,page_size:page_size,foreigns:foreigns};
    };
