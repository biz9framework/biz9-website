    ...
    it("_connect", () => {
        series([
            function(call) {
                ...
                let item_1 = {title:'cool1'};
                let item_2 = {title:'cool2'};
                let item_3 = {title:'cool3'};

                let find_me = Obj.filter('title','cool2',[item_1,item_2,item_3]);
                ...
                //console.log(DateTime.get_pretty("2026-03-08T20:28:17.588Z"));
                //console.log(DateTime.get_date("2026-03-11T00:00:00-04:00"));
                //console.log(DateTime.get_time("13:48"));

                //return moment(date+ " " + time, 'YYYY-MM-DD h:mm').format("dddd MMMM Do, YYYY h:mm a");

                //console.log(DateTime.check_is_iso("2026-03-08T20:28:17.588Z"));
                /*
