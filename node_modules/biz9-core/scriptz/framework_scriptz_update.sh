...
des_branch='stable'
#_branch="unstable"
G_BIZ_SCRIPT_FOLDER="${BIZ9_HOME}/biz9-scriptz/src/${des_branch}"
...
echo "change-request-${_branch}-update-done"
#cms
...
echo "website-${_branch}-update-done"
echo "----------------------------------"
